...
{
	quart rotX = quart::fromAxisAndAngle(Math::Vector3::UNIT_X, m_rotation.x());
	quart rotY = quart::fromAxisAndAngle(Math::Vector3::UNIT_Y, m_rotation.y());
	quart rotZ = quart::fromAxisAndAngle(Math::Vector3::UNIT_Z, m_rotation.z());
