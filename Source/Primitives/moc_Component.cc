...
QT_MOC_LITERAL(4, 35, 9)
    ...
    "Component\0syncTransform\0\0Transform\0"
    "transform"
};
...
void Component::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->syncTransform((*reinterpret_cast< const Transform(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Component::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Component.data,
      qt_meta_data_Component,  qt_static_metacall, 0, 0}
};
