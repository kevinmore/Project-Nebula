...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ObjectManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 59, 30)
    ...
    "ObjectManager\0addComponentToRenderQueue\0"
    "\0ComponentPtr\0comp\0removeComponentFromRenderQueue"
};
...
void ObjectManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->addComponentToRenderQueue((*reinterpret_cast< ComponentPtr(*)>(_a[1]))); break;
        case 1: _t->removeComponentFromRenderQueue((*reinterpret_cast< ComponentPtr(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject ObjectManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ObjectManager.data,
      qt_meta_data_ObjectManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ObjectManager.stringdata))
