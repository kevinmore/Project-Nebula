...
{   
    ...
    float specular = 0.0;
	DiffuseColor = material.Kd * Light.Color * Light.Intensity * NdotL;
    if (NdotL > 0.0) 
	{   
	...
	vec4 finalValue = Light.Color * NdotL * specular * material.shininessStrength;
	SpecularColor = material.Ks * finalValue;                                                                                         
