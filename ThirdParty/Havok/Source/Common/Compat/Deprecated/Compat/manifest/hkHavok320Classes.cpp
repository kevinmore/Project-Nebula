...
namespace hkHavok320Classes
{
	...
	const hkClassEnum* hkxAttributeHintEnum = reinterpret_cast<const hkClassEnum*>(&hkscenedata_attributes_hkxAttributeEnums[0]);
	...
	const hkClassEnum* hkMultiThreadLockTypesEnum = reinterpret_cast<const hkClassEnum*>(&hkdynamics_world_hkMultiThreadLockEnums[0]);
