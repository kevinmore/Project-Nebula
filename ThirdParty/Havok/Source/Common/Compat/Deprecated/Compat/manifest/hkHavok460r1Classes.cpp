...
namespace hkHavok460r1Classes
{
	...
	const hkClassEnum* hkSkeletalAnimationAnimationTypeEnum = reinterpret_cast<const hkClassEnum*>(&hkSkeletalAnimationEnums[0]);
	...
	const hkClassEnum* hkConstraintInstanceCloningModeEnum = reinterpret_cast<const hkClassEnum*>(&hkConstraintInstanceEnums[3]);
	...
	const hkClassEnum* ResultEnum = reinterpret_cast<const hkClassEnum*>(&hkdynamics_world_hkWorldObjectEnums[0]);
	...
	const hkClassEnum* hkSerializedAgentNnEntrySerializedAgentTypeEnum = reinterpret_cast<const hkClassEnum*>(&hkSerializedAgentNnEntryEnums[0]);
