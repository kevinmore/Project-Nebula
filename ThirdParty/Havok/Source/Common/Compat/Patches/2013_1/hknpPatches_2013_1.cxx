...
HK_PATCH_BEGIN("hknpCompressedMeshShape", 0, "hknpCompressedMeshShape", 1)
	HK_PATCH_MEMBER_RENAMED("quadIsFlat", "old_quadIsFlat")
	HK_PATCH_MEMBER_RENAMED("trianglesWithDuplicatedEdges", "old_trianglesWithDuplicatedEdges")
	HK_PATCH_MEMBER_ADDED("quadIsFlat", TYPE_STRUCT, "hkBitField_new", 0)
	HK_PATCH_MEMBER_ADDED("trianglesWithDuplicatedEdges", TYPE_STRUCT, "hkBitField_new", 0)
	HK_PATCH_FUNCTION(hknpCompressedMeshShape_0_to_1)
	HK_PATCH_MEMBER_REMOVED("old_quadIsFlat", TYPE_STRUCT, "hkBitField", 0)
	HK_PATCH_MEMBER_REMOVED("old_trianglesWithDuplicatedEdges", TYPE_STRUCT, "hkBitField", 0)
