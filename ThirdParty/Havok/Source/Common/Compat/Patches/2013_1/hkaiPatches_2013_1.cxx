...
HK_PATCH_BEGIN("hkaiSilhouetteRecorderSilhouettesSteppedEvent", 2, "hkaiSilhouetteRecorderSilhouettesSteppedEvent", 3)
	HK_PATCH_MEMBER_RENAMED("updatedSections", "old_updatedSections")
	HK_PATCH_MEMBER_ADDED("updatedSections", TYPE_STRUCT, "hkBitField_new", 0)
	HK_PATCH_FUNCTION(hkaiSilhouetteRecorderSilhouettesSteppedEvent_2_to_3)
	HK_PATCH_MEMBER_REMOVED("old_updatedSections", TYPE_STRUCT, "hkBitField", 0)
	...
	HK_PATCH_DEPENDS("hkBitField_new", 1)
HK_PATCH_END()

HK_PATCH_BEGIN("hkaiCuttingGeometryInfo", 0, "hkaiCuttingGeometryInfo", 1)
	HK_PATCH_MEMBER_RENAMED("cuttingTriangles", "old_cuttingTriangles")
	HK_PATCH_MEMBER_ADDED("cuttingTriangles", TYPE_STRUCT, "hkBitField_new", 0)
	HK_PATCH_FUNCTION(hkaiCuttingGeometryInfo_0_to_1)
	HK_PATCH_MEMBER_REMOVED("old_cuttingTriangles", TYPE_STRUCT, "hkBitField", 0)
	HK_PATCH_DEPENDS("hkBitFieldBasehkBitFieldStoragehkArrayunsignedinthkContainerHeapAllocator", 0)
	HK_PATCH_DEPENDS("hkBitField", 0)
	HK_PATCH_DEPENDS("hkBitField_new", 1)
HK_PATCH_END()
