...
void hkDisplayTaperedCapsule::buildGeometry()
{
	HK_ASSERT2(0x612ccd44, m_geometry==HK_NULL, "Already built");
	m_geometry = new hkGeometry();
	hkGeometryUtils::createTaperedCapsuleGeometry(m_top, m_bottom, m_topRadius, m_bottomRadius, m_numHeightSegments, m_numSides, hkTransform::getIdentity(), *m_geometry);
}

void hkDisplayTaperedCapsule::getWireframeGeometry(hkArrayBase<hkVector4>& lines, hkMemoryAllocator& alloc)
{
	//TODO
}
