...
#define HK_TRANSPOSE4f_SWAP(a,b) t = a; a = b; b = t
#define HK_TRANSPOSE4f(v0,v1,v2,v3) { hkFloat32 t; \
...
#define HK_TRANSPOSE3f_SWAP(a,b) t = a; a = b; b = t
#define HK_TRANSPOSE3f(v0,v1,v2) { hkReal t; \
...
#define HK_QUADFLOAT_CONSTANT(a,b,c,d) ((hkQuadFloat32){{a, b}, {c, d}})

#define HK_QUADINT_CONSTANT(a, b, c, d)		{(a), (b), (c), (d)}

#else

// Fall back to FPU-only implementation
