...
void hkpBallSocketDrawer::drawConstraint(const hkpBallAndSocketConstraintData* constraintData, const hkTransform& localToWorldA, const hkTransform& localToWorldB, hkDebugDisplayHandler* displayHandler, int id, int tag)
{
	const hkpSetLocalTranslationsConstraintAtom& pivots = constraintData->m_atoms.m_pivots;
