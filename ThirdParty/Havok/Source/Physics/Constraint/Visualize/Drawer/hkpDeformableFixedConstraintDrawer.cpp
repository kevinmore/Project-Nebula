...
void hkpDeformableFixedConstraintDrawer::drawConstraint(const hkpDeformableFixedConstraintData* constraintData, const hkTransform& localToWorldA, const hkTransform& localToWorldB, hkDebugDisplayHandler* displayHandler, int id, int tag)
{
