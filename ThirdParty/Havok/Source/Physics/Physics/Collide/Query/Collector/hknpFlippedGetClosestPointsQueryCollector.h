...
#ifndef HKNP_FLIPPED_GET_CLOSEST_POINTS_QUERY_COLLECTOR_H
#define HKNP_FLIPPED_GET_CLOSEST_POINTS_QUERY_COLLECTOR_H
...
/// collector.
class hknpFlippedGetClosestPointsQueryCollector : public hknpCollisionQueryCollector
{
	public:

		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_PHYSICS, hknpFlippedGetClosestPointsQueryCollector );

		/// Constructor.
		HK_FORCE_INLINE hknpFlippedGetClosestPointsQueryCollector( hknpCollisionQueryCollector* childCollector );
...
#include <Physics/Physics/Collide/Query/Collector/hknpFlippedGetClosestPointsQueryCollector.inl>


#endif // HKNP_FLIPPED_GET_CLOSEST_POINTS_QUERY_COLLECTOR_H
