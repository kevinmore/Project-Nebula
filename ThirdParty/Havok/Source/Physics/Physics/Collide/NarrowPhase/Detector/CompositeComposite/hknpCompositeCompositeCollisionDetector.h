...
#ifndef HKNP_COMPOSITE_COMPOSITE_COLLISION_DETECTOR_H
#define HKNP_COMPOSITE_COMPOSITE_COLLISION_DETECTOR_H

#include <Physics/Physics/Collide/NarrowPhase/Detector/hknpCollisionDetector.h>


///
class hknpCompositeCompositeCollisionDetector : public hknpCompositeCollisionDetector
{
	public:

		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_PHYSICS, hknpCompositeCompositeCollisionDetector );
...
#endif // HKNP_COMPOSITE_COMPOSITE_COLLISION_DETECTOR_H
