...
hknpVehicleDefaultEngine::hknpVehicleDefaultEngine()
{
	m_minRPM = 1000.0f;
	m_optRPM = 4000.0f;
	m_maxRPM = 6000.0f;
...
void hknpVehicleDefaultEngine::calcEngineInfo( const hkReal deltaTime, const hknpVehicleInstance* vehicle, const hknpVehicleDriverInput::FilteredDriverInputOutput& filteredDriverInputInfo, const hknpVehicleTransmission::TransmissionOutput& transmissionInfo, EngineOutput& engineOutput )
{
	...
	HK_ASSERT2(0x4e9c6766, transmissionInfo.m_transmissionRPM >= 0.f, "The RPM passed to hknpVehicleDefaultEngine::calcEngineInfo from the transmission is negative.");
