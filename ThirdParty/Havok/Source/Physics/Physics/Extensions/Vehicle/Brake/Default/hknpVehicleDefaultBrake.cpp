...
hknpVehicleDefaultBrake::hknpVehicleDefaultBrake()
{
...
void hknpVehicleDefaultBrake::calcBreakingInfo( const hkReal deltaTime, const hknpVehicleInstance* vehicle, const hknpVehicleDriverInput::FilteredDriverInputOutput& filteredDriverInfo, WheelBreakingOutput& breakingInfo )
{
	...
	hkBool wheelsShouldBlock = false;
	{
		for (int w_it=0; w_it < vehicle->m_data->m_numWheels; w_it++)
		{
			...
			// NORMAL (PEDAL) BRAKE
			{
				...
				HK_ASSERT2(0xad45dee3, deltaTime > HK_REAL_EPSILON, "Non-zero deltaTime required for hknpVehicleDefaultBrake::calcBreakingInfo.");
