...
#ifndef HKNP_VEHICLE_FRICTION_H
#define HKNP_VEHICLE_FRICTION_H

extern const class hkClass hknpVehicleFrictionDescriptionAxisDescriptionClass;
extern const class hkClass hknpVehicleFrictionStatusAxisStatusClass;
...
enum { HKNP_VEHICLE_FRICTION_NUM_AXES = 2 };


/// Info about the time for our vehicle.
struct hknpVehicleStepInfo
{
	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_VEHICLE, hknpVehicleStepInfo );
...
/// The structure hknpVehicleFrictionDescription is used by vehicle dynamics as a const description
...
/// Please examine hknpVehicleFrictionDescription::Cinfo for details on how to setup this structure
/// and information on its various members.
struct hknpVehicleFrictionDescription
{
	HK_DECLARE_REFLECTION();
	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_ACTION, hknpVehicleFrictionDescription);

		/// A helper construction info class to fill in the values for a hknpVehicleFrictionDescription.
		/// All values should be specified in chassis local space.
	struct Cinfo
	{
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_VEHICLE, hknpVehicleFrictionDescription::Cinfo );
	...
	{
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_VEHICLE, hknpVehicleFrictionDescription::AxisDescription );
		HK_DECLARE_REFLECTION();
		//
...
struct hknpVehicleFrictionStatus
{
	HK_DECLARE_REFLECTION();
	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_CONSTRAINT, hknpVehicleFrictionStatus);
	...
	hknpVehicleFrictionStatus( hkFinishLoadedObjectFlag flag )
	{
		// skip initialization of m_axis[0/1]
	}
};

#endif // HKNP_VEHICLE_FRICTION_H
