...
#ifndef HKNP_1D_ANGULAR_FOLLOW_CAM_CINFO_H
#define HKNP_1D_ANGULAR_FOLLOW_CAM_CINFO_H


/// All the parameters needed to construct a hknp1dAngularFollowCam.
class hknp1dAngularFollowCamCinfo
{
	public:

		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_CAMERA, hknp1dAngularFollowCamCinfo);
		...
		{
			public:
				HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_VEHICLE, hknp1dAngularFollowCamCinfo::CameraSet );
...
#endif	// HKNP_1D_ANGULAR_FOLLOW_CAM_CINFO_H
