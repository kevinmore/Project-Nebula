...
#ifndef HKNP_CHARACTER_PROXY_CINFO_H
#define HKNP_CHARACTER_PROXY_CINFO_H
...
/// Information used to construct a hknpCharacterProxy.
struct hknpCharacterProxyCinfo : public hkReferencedObject
{
	public:
		...
		hknpCharacterProxyCinfo()
		{
			...
			m_userPlanes = 4;
			m_maxCharacterSpeedForSolver = 10.f;
	...
	public:
		...
		/// Initial rotation for the proxy in world space.
		...
		/// Controls the default dynamic friction for surfaces hit. A value of 0 maintains character momentum.
		/// A value of 1 clips all momentum against the normal of the surface hit.
		...
		/// The world the character will be added to.
		...
		/// dynamic objects. By default this is HK_REAL_MAX, i.e., the character controller
		/// is infinitely strong.
		hkReal m_characterStrength;	//+default(7.9E+28f)
									//+hk.RangeReal(absmin=0,absmax=7.9E+28)
									//+hk.Description("The maximum constant force that the character controller can impart onto dynamic objects. By default this is HK_REAL_MAX, i.e. the character controller is infinitely strong.")
		...
		/// the integrate for that time step. The default is 10 iterations.
		...
		/// This flag determines if the character controller should be present in the simulated world as a special phantom.
		/// By default this is set to false, i.e., the shape is not added as a phantom body.
		hkBool m_presenceInWorld;	//+default(false)
								//+hk.Description("This flag determines if the character controller should be present in the simulated world as a special phantom. By default this is set to false, i.e., the shape is not added as a phantom body.")

	public:

		hknpCharacterProxyCinfo(hkFinishLoadedObjectFlag flag) : hkReferencedObject(flag) {}
};

#endif // HKNP_CHARACTER_PROXY_CINFO_H
