...
#ifndef HKNP_CHARACTER_STATE_ON_GROUND_H
#define HKNP_CHARACTER_STATE_ON_GROUND_H
...
class hknpCharacterStateOnGround : public hknpCharacterState
{
	public:
...
#endif // HKNP_CHARACTER_STATE_ON_GROUND_H
