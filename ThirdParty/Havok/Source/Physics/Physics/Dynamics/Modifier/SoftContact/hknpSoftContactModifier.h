...
#ifndef HKNP_SOFT_CONTACT_MODIFIER_H
#define HKNP_SOFT_CONTACT_MODIFIER_H
...
/// A modifier to soften contacts between bodies.
class hknpSoftContactModifier : public hknpModifier
{
	public:

		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_PHYSICS, hknpSoftContactModifier );

		HK_FORCE_INLINE int getEnabledFunctions()
		{
			return	( 1 << FUNCTION_MANIFOLD_CREATED_OR_DESTROYED ) |
					( 1 << FUNCTION_MANIFOLD_PROCESS ) |
...
#endif	//HKNP_SOFT_CONTACT_MODIFIER_H
