...
#include <Physics2012/Collide/Util/ShapeVirtualTable/hkpShapeVirtualTableUtil_SelfTest.inl>

void HK_CALL hkpShapeVirtualTableUtil::selfTest()
{
	// Test each profile
	hkpShapeVirtualTableSelfTest::testProfile< PROFILE_INTEGRATE >();
	hkpShapeVirtualTableSelfTest::testProfile< PROFILE_COLLIDE >();
	hkpShapeVirtualTableSelfTest::testProfile< PROFILE_COLLIDE_STATIC_COMPOUND >();
	hkpShapeVirtualTableSelfTest::testProfile< PROFILE_COLLISION_QUERY >();
	hkpShapeVirtualTableSelfTest::testProfile< PROFILE_RAYCAST_QUERY >();
	hkpShapeVirtualTableSelfTest::testProfile< PROFILE_CHARACTER_PROXY >();
}
