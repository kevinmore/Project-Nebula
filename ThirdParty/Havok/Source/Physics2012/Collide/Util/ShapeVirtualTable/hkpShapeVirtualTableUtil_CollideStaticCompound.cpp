...
// Implementations for hkRegisterShapeFunctions_StaticCompound()
HKP_DECLARE_SHAPE_VTABLE_SET_PROFILE( hkpShapeVirtualTableUtil::PROFILE_COLLIDE_STATIC_COMPOUND );
