...
// Generated from 'Physics2012/Dynamics/Constraint/Breakable/hkpBreakableConstraintData.h'
...
const hkClass& HK_CALL hkpBreakableConstraintData::staticClass()
{
	return hkpBreakableConstraintDataClass;
}
HK_COMPILE_TIME_ASSERT2( \
	sizeof(hkIsVirtual(static_cast<hkpBreakableConstraintData*>(0))) == sizeof(hkBool::CompileTimeTrueType), \
	REFLECTION_PARSER_VTABLE_DETECTION_FAILED );
static void HK_CALL finishLoadedObjecthkpBreakableConstraintData(void* p, int finishing = 1)
{
	hkFinishLoadedObjectFlag f;
	f.m_finishing = finishing;
	new (p) hkpBreakableConstraintData(f);
}
static void HK_CALL cleanupLoadedObjecthkpBreakableConstraintData(void* p)
{
	static_cast<hkpBreakableConstraintData*>(p)->~hkpBreakableConstraintData();
}
static const void* HK_CALL getVtablehkpBreakableConstraintData()
{
	#if HK_LINKONCE_VTABLES==0
	#if HK_HASHCODE_VTABLE_REGISTRY==1
	return ((const void*)(typeid(hkpBreakableConstraintData).hash_code()));
	#else
	return ((const void*)(typeid(hkpBreakableConstraintData).name()));
	#endif
	#else
	union { HK_ALIGN16(void* ptr); char buf[sizeof(hkpBreakableConstraintData)]; } u;
	hkFinishLoadedObjectFlag f;
	new (u.buf) hkpBreakableConstraintData(f);
	return u.ptr;
	#endif
}
extern const hkTypeInfo hkpBreakableConstraintDataTypeInfo;
const hkTypeInfo hkpBreakableConstraintDataTypeInfo(
	"hkpBreakableConstraintData",
	"!hkpBreakableConstraintData",
	finishLoadedObjecthkpBreakableConstraintData,
	cleanupLoadedObjecthkpBreakableConstraintData,
	getVtablehkpBreakableConstraintData(),
	sizeof(hkpBreakableConstraintData)
	);
#endif
