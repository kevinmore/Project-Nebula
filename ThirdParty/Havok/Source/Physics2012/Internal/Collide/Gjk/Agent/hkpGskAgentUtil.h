...
void HK_CALL hkGskAgentUtil_processCollisionNoTim(const hkpAgent3Input& input, hkpAgentEntry* entry, hkpAgentData* agentData, hkpGskCache& gskCache, hkpGskManifold& gskManifold, hkVector4& separatingNormal, int explicitlyAllowNewPoint, hkpProcessCollisionOutput& output);
